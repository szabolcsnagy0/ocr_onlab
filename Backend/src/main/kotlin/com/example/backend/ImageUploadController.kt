...
@RestController
@RequestMapping("")
class ImageUploadController(val textDetectionService: TextDetectionService) {
    ...
    fun upload(
        ...
        return textDetectionService.runDetection(frontImagePath = frontFileNameAndPath, backImagePath = backFileNameAndPath)
    }
