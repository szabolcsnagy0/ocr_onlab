...
class Person:
    ...
    def to_dict(self):
        return {"Családi és utónév/Family name and Given name:": self.name,
                "Nem/Sex:": self.sex,
                "Állampolgárság/Nationality:": self.nationality,
                "Születési idő/Date of birth:": self.birth,
                "Érvényességi idő/Date of expiry:": self.expiry,
                "Okmányazonosító/Doc.No.:": self.doc_nr,
                "CAN:": self.can,
                "Születési hely/Place of birth:": self.place_of_birth,
                "Születési családi és utónév/Family name and Given name at birth:": self.birth_name,
                "Anyja születési neve/Mother's maiden name:": self.mother,
                "Kiállító hatóság/Issuing authority:": self.authority}
